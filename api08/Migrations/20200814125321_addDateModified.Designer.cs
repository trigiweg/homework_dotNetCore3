...
namespace api08.Migrations
{
    ...
    [Migration("20200814125321_addDateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api08.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("api08.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api08.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("api08.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("api08.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api08.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("api08.Models.Course", b =>
                {
                    b.HasOne("api08.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("api08.Models.CourseInstructor", b =>
                {
                    b.HasOne("api08.Models.Course", "Course")
                    ...
                    b.HasOne("api08.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("api08.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("api08.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("api08.Models.OfficeAssignment", b =>
                {
                    b.HasOne("api08.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("api08.Models.OfficeAssignment", "InstructorId")
